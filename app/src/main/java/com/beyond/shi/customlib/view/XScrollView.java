package com.beyond.shi.customlib.view;
...
/**
 * @Package com.wang.mybasedemo.view.refresh
 * @Title
 * @Description
 * @author WangJinya
 * @Time 2016/9/6 13:45
...
//    private static final String TAG = "XScrollView";
    ...
    private final static float OFFSET_RADIO = 1.2f;
    ...
    private void initWithContext(Context context) {
        ...
        mFootLayout = (LinearLayout) mLayout.findViewById(R.id.footer_layout);
        mFootLayout.addView(mFooterView, params);
